            ...
            <div class="container-fluid col-lg-12" >
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="title" type="text" class="form-control" placeholder="Title" name="title" value="{{old('title')}}" ><br>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    @csrf
                    <h4>Post Content</h4>
                    <textarea id="summernote" name=content style="min-height: 400px;" value="{{old('content')}}"></textarea>
